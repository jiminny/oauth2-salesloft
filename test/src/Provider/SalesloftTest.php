...
class SalesloftTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->provider = new \Jiminny\OAuth2\Client\Provider\Salesloft([
    ...
    {
        $this->assertEquals('https://accounts.salesloft.com', $this->provider->getHost());
    }
    ...
    public function testUserData()
    {
        ...
        $name = $resourceOwnerArray['data']['name'],
        $email = $resourceOwnerArray['data']['email'];
